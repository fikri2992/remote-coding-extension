    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="bg-card p-4 lg:p-6 rounded-lg shadow-sm border border-border">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <Link to="/files" className="flex flex-col items-center p-3 lg:p-4 bg-muted hover:bg-muted/70 rounded-lg transition-colors min-h-[80px] lg:min-h-[100px]">
            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-blue-100 rounded-full flex items-center justify-center mb-2 text-blue-600">
              <Folder className="w-5 h-5 lg:w-6 lg:h-6" />
            </div>
            <span className="text-xs lg:text-sm font-medium text-center">Files</span>
          </Link>

          <Link to="/terminal" className="flex flex-col items-center p-3 lg:p-4 bg-muted hover:bg-muted/70 rounded-lg transition-colors min-h-[80px] lg:min-h-[100px]">
            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-green-100 rounded-full flex items-center justify-center mb-2 text-green-600">
              <TerminalIcon className="w-5 h-5 lg:w-6 lg:h-6" />
            </div>
            <span className="text-xs lg:text-sm font-medium text-center">Terminal</span>
          </Link>

          <Link to="/git" className="flex flex-col items-center p-3 lg:p-4 bg-muted hover:bg-muted/70 rounded-lg transition-colors min-h-[80px] lg:min-h-[100px]">
            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-yellow-100 rounded-full flex items-center justify-center mb-2 text-yellow-600">
              <GitBranch className="w-5 h-5 lg:w-6 lg:h-6" />
            </div>
            <span className="text-xs lg:text-sm font-medium text-center">Git</span>
          </Link>

          <Link to="/settings" className="flex flex-col items-center p-3 lg:p-4 bg-muted hover:bg-muted/70 rounded-lg transition-colors min-h-[80px] lg:min-h-[100px]">
            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-purple-100 rounded-full flex items-center justify-center mb-2 text-purple-600">
