...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      {/* Welcome Section */}
      <div className="bg-card p-4 lg:p-6 rounded-lg shadow-sm border border-border neo:rounded-none neo:border-[5px] neo:shadow-[8px_8px_0_0_rgba(0,0,0,1)] dark:neo:shadow-[8px_8px_0_0_rgba(255,255,255,0.35)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
          <div className="p-3 lg:p-4 rounded-lg text-center bg-primary/10 neo:rounded-none neo:border-4 neo:border-border neo:shadow-[5px_5px_0_0_rgba(0,0,0,1)] dark:neo:shadow-[5px_5px_0_0_rgba(255,255,255,0.35)]">
          ...
          <div className="p-3 lg:p-4 rounded-lg text-center bg-green-500/10 neo:rounded-none neo:border-4 neo:border-border neo:shadow-[5px_5px_0_0_rgba(0,0,0,1)] dark:neo:shadow-[5px_5px_0_0_rgba(255,255,255,0.35)]">
          ...
          <div className="p-3 lg:p-4 rounded-lg text-center sm:col-span-2 lg:col-span-1 bg-purple-500/10 neo:rounded-none neo:border-4 neo:border-border neo:shadow-[5px_5px_0_0_rgba(0,0,0,1)] dark:neo:shadow-[5px_5px_0_0_rgba(255,255,255,0.35)]">
